...
cd /storage/user/jmao/login-1/jmao/miniaod/CMSSW_9_4_9/src/cms_lpc_llp/jet_timing_studies/condor_scripts
gfal-copy bbbb_ggh_mh125_mx50_pl500_signal_aod_test.py ${runDir}

#Run cmsenv in an existing CMSSW directory on login-1
cd /storage/user/jmao/login-1/jmao/miniaod/CMSSW_9_4_9/src
